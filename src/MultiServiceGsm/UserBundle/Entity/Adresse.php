 ...
 * @ORM\Entity(repositoryClass="MultiServiceGsm\UserBundle\Repository\AdresseRepository")
 */
class Adresse
{
    /**
     ...
     * @return Adresse
     */
    public function setUtilisateur(\MultiServiceGsm\UserBundle\Entity\User $utilisateur)
    {
